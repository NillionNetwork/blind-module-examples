...
async function runStandardCollectionExample() {
    try {
        ...
        console.log('✅ All 3 records created:', JSON.stringify(createRecordsResult, null, 2));
        // 3. Update record 2
        console.log('\n3. Updating record 2...');
        ...
        console.log('📋 Remaining records:', JSON.stringify(remainingRecords.data, null, 2));
        // Summary
        console.log('\n✅ Example completed successfully!');
        console.log(`Collection ID: ${collectionId}`);
        console.log(`Remaining records: ${remainingRecords.data.length}`);
        console.log(`You can view the collection at: https://collection-explorer.nillion.com/collections/${collectionId}`);
        return {
            collectionId,
...
runStandardCollectionExample()
    ...
    .catch((error) => {
    console.error('Failed to run standard collection example:', JSON.stringify(error));
    process.exit(1);
});
