...
import { findContactByNameQuery, countAllContactsQuery, searchContactsByPartialNameQuery, getContactsAlphabeticallyQuery, getContactsWithoutSensitiveDataQuery, checkIfNameExistsQuery, findContactsWithNamePatternsQuery, getPaginatedContactsQuery, getRecentContactsQuery, } from '../query-examples-string.js';
...
async function plaintextQueryExample() {
    try {
        ...
        console.log(`Found ${partialMatch.length} contacts with "John" in their name:`, JSON.stringify(partialMatch, null, 2));
